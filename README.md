...
| 추론 imgsz | DUT AP50 | DUT far | DUT <8px | FP/img |
|---|---:|---:|---:|---:|
| **640 (=학습)** | **0.951** | **0.944** | **0.934** | 0.08 |
| 960 | 0.819 | 0.722 | 0.552 | 0.96 |
| 1280 | 0.598 | 0.369 | 0.162 | 2.09 |

- **YOLO와 정반대**: pos-emb 재생성에도 붕괴 — 쿼리·anchor가 학습 스케일 특화. **"960 학습+1280 추론" 레시피는 DETR 계열 이식 불가** → D-FINE-L@960(진행 중)은 **추론 960 고정** 전제, 1280은 검증만.
